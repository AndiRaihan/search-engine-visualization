...
<required_reading>
Read `C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/gsd-core/references/ai-evals.md` — specifically the rubric design and domain expert sections.
</required_reading>
