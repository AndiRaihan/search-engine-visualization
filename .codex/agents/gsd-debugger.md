...
<required_reading>
@C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex
                  → checks C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/gsd-core
                  → writes to C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/gsd-core/hooks/
...
@C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/gsd-core/references/thinking-models-debug.md
...
- Read @C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/gsd-core/references/common-bug-patterns.md
