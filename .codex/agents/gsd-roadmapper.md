...
Reference full template: `C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/gsd-core/templates/state.md`.
