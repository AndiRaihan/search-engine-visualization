...
Use template from `C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/gsd-core/templates/UI-SPEC.md`.
...
Read template: `C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/gsd-core/templates/UI-SPEC.md`
