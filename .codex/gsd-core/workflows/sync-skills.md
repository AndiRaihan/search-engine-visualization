...
INSTALL_JS_GLOBAL="C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
