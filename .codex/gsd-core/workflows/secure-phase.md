...
```
Agent(
  prompt="Read C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/gsd-core/templates/SECURITY.md`
