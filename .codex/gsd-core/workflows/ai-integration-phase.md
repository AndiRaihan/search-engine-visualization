...
<required_reading>
@C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/gsd-core/references/ai-frameworks.md
@C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/agents/gsd-eval-planner.md for instructions.
