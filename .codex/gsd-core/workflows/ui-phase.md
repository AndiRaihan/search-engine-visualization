...
```markdown
Read C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/agents/gsd-ui-checker.md for instructions.
