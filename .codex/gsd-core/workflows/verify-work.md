...
<template>
@C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/gsd-core/workflows/transition.md`.
...
- Follow @C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/gsd-core/workflows/diagnose-issues.md
