...
- **Global scope**: `C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/notes/`)
...
2. Glob `C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/notes/*.md` (if directory exists) — global notes
...
Global (C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/notes/` — works in any directory
