...
The keys live in `.codex/settings.json` (project) or `C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/settings.json` (global) — **not** in `.planning/config.json`:
