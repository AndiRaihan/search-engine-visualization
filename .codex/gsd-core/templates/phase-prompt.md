...
<!-- For checkpoint task examples and patterns, see @C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/gsd-core/references/checkpoints.md -->
...
See `C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/gsd-core/references/tdd.md` for TDD plan structure.
...
See `C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/gsd-core/templates/user-setup.md` for full schema and examples
...
See `C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/gsd-core/workflows/verify-phase.md` for verification logic.
