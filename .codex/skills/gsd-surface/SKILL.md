...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/.gsd-surface.json`
(sibling to `C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/skills/gsd-*/`.
...
(`~/.codex`), NOT the skills sub-directory (`C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/skills`).
...
`C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/.gsd-surface.json`).
...
<execution_context>
Surface state file: `C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/.gsd-surface.json`
Install profile marker: `C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/.gsd-profile`
Skill dirs: `C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/skills/gsd-*/`
Engine module: `C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `C:/Tugas Raihan/Latihan Python/search_engine_visualization/.codex/gsd-core/bin/lib/clusters.cjs`
</execution_context>
